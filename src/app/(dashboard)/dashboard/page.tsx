    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        ...
        <Link
          ...
          className="bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 rounded-xl p-6 hover:shadow-md transition-shadow group"
        >
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="text-xs font-semibold bg-purple-100 text-purple-700 px-2 py-1 rounded">Marketplace</span>
          </div>
          <h3 className="font-semibold text-gray-900 mb-1">Kelola Harga Foto</h3>
          <p className="text-sm text-gray-600">Set harga per foto dan mulai jual di marketplace FotoCloud</p>
        ...
        <Link
          href="/marketplace"
          className="bg-gradient-to-br from-green-50 to-blue-50 border border-green-200 rounded-xl p-6 hover:shadow-md transition-shadow group"
        >
          <div className="flex items-start justify-between mb-4">
            ...
            <span className="text-xs font-semibold bg-green-100 text-green-700 px-2 py-1 rounded">Public</span>
          </div>
          <h3 className="font-semibold text-gray-900 mb-1">Lihat Marketplace</h3>
          <p className="text-sm text-gray-600">Jelajahi semua foto yang dijual di platform FotoCloud</p>
